...
namespace WeatherRegistry
{
  ...
  public class Weather : ScriptableObject
  {
    ...
    public Weather(string name = "None", ImprovedWeatherEffect effect = default)
    {
      ...
      WeatherManager.RegisterWeather(
        new Runtime.WeatherRuntimeDefinition(name, effect)
        {
          Color = ColorHelper.ToTMPColorGradient(this.Color),
          Config = this.Config,
          // Origin = this.Origin,
          VanillaWeatherType = this.VanillaWeatherType
        }
      );
    }
    ...
    {
      return ConfigHelper.GetAlphanumericName(this.Name);
    }
