...
namespace WeatherRegistry
{
  ...
  {
    public RegistryWeather Weather { get; set; }
  }
  ...
  internal abstract class ConfigHandler<T, CT> : Definitions.ConfigHandler<T, CT>
  {
    ...
    public void SetConfigEntry(RegistryWeather weather, string configTitle, ConfigDescription configDescription = null)
    {
  ...
  internal class ConfigHelper
  {
    ...
    private static Dictionary<string, RegistryWeather> _weathersDictionary = null;
    public static Dictionary<string, RegistryWeather> StringToWeather
    {
      get
      {
        ...
        Dictionary<string, RegistryWeather> Weathers = [];
    ...
    public static RegistryWeather ResolveStringToWeather(string str)
    {
    ...
    public static string GetAlphanumericName(RegistryWeather weather)
    {
      Regex regex = new(@"^[0-9]+|[-_/\\\ ]");
    ...
    public static WeatherRarity[] ConvertStringToWeatherWeights(string str)
    {
      ...
      foreach (string rarity in rarities)
      {
        ...
        RegistryWeather weather = ResolveStringToWeather(rarityData[0]);
