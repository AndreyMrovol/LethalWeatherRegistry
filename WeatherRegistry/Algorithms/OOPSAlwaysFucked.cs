...
internal class OOPSAlwaysFuckedAlgorithm : WeatherSelectionAlgorithm
{
  public override Dictionary<SelectableLevel, LevelWeatherType> SelectWeathers(int connectedPlayersOnServer, StartOfRound startOfRound)
  {
    ...
    foreach (SelectableLevel level in levels)
    {
      ...
      List<LevelWeatherType> possibleNewWeathers =
      [
      ...
      Weather selectedWeather = WeatherManager.GetWeather((LevelWeatherType)random.Next(0, possibleWeathers.Keys.Count));
