...
{
  public class ImprovedWeather : IWeatherEffectAbstraction
  {
    ...
    public ImprovedWeather(string name = "None", ImprovedWeatherEffect effect = default)
    {
    ...
    public (bool isWTW, int weight) GetWeatherToWeatherWeight(ImprovedWeather previousWeather)
    {
    ...
    public static TMP_ColorGradient CreateColorGradient(Color color)
    {
